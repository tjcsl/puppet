class xserver {
    ...
    # Window managers
    package { ['xfce4','gnome','kde','kdeutils','i3-wm','i3lock','awesome','wmii','dwm','xorg-twm','icewm','fluxbox','lxde','metacity','xmonad','xmobar-git','xmonad-contrib','xscreensaver-arch-logo']:
        ensure  => latest,
        require => Class[aur],
        install_options => '--needed'
    }
